        ...
        <div>
            <Card className="bg-dark text-white mb-5 border-0">
                ...
                <Card.ImgOverlay className="text-center">
                    <Card.Title style={{ color: "#2ACB35" }} className="logo font1">A Natural way of improving your health.</Card.Title>
                    <Card.Text style={{ fontFamily: "'Poppins', sans-serif", fontWeight: "300" }} className="mb-3 font2">
